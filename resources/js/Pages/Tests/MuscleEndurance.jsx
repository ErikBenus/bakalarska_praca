                ...
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div className="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                        <div className="p-6 bg-white border-b border-gray-200">
                            <h2 className="mt-8 mb-4 text-lg font-semibold">Svalová vytrvalosť – čo to je a ako
                                funguje?</h2>

                            <p className="mb-4">
                                Testy svalovej vytrvalosti merajú schopnosť svalov vydržať opakované kontrakcie počas
                                dlhšieho časového obdobia. Tieto testy sú určené na hodnotenie fyzickej odolnosti a
                                efektivity svalového systému, čo je dôležité pre športovcov aj pre tých, ktorí sa
                                zameriavajú na zlepšenie svojej celkovej kondície.
                            </p>

                            <h3 className="mt-8 mb-4 text-md font-semibold">Testy na svalovú vytrvalosť</h3>

                            <p className="mb-4">
                                Testy svalovej vytrvalosti zahŕňajú rôzne cvičenia, ktoré hodnotia silu a vytrvalosť
                                svalov. Tieto testy sa vykonávajú v rámci rôznych cvikov, kde sa sleduje čas, ktorý
                                klient vydrží v danej pozícii, alebo počet opakovaní daného cviku.
                            </p>
                            ...
                            <ul className="mb-4 list-disc list-inside">
                                <li><strong>Zlepšenie svalovej vytrvalosti</strong> – testy poskytujú prehľad o
                                    schopnosti svalov vykonávať viac opakovaní, čo je dôležité pre rôzne športy a
                                    každodennú aktivitu.
                                </li>
                                <li><strong>Monitorovanie pokroku</strong> – pravidelné testovanie pomáha sledovať
                                    zlepšenie vytrvalosti a efektívnosti svalov v rôznych cvikoch.
                                </li>
                                <li><strong>Bezpečné a efektívne hodnotenie</strong> – testy umožňujú bezpečne hodnotiť
                                    svalovú vytrvalosť bez potreby extrémneho zaťaženia alebo rizika zranenia.
                                </li>
                            </ul>
                            ...
                            <p className="mb-4">
                                Na základe výsledkov týchto testov vám môžeme poskytnúť odporúčania na zlepšenie
                                svalovej vytrvalosti a konkrétne cvičenia, ktoré vám pomôžu dosiahnuť lepšie výsledky v
                                tejto oblasti.
                            </p>
